...
import com.example.auth_service.dtos.ApiError;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorizeHttpsRequests ->
                        authorizeHttpsRequests
                                ...
                                .requestMatchers(HttpMethod.GET).hasAnyRole(AppConstants.GUEST_ROLE, AppConstants.ADMIN_ROLE)
...
//                    Map<String, Object> errorMap = Map.of("message", message, "statusCode",404);
                    var apiError = ApiError.of(HttpStatus.UNAUTHORIZED.value(), "Unauthorized Access !!, message from SecurityFilterChain", message, request.getRequestURI(), true);
